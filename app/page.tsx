export default function Home() {
  return (
    <>
      <div className="flex flex-col items-center p-6 pt-0 gap-6">
          <h3 className="text-preset-8 text-tertiary">SO, YOU WANT TO TRAVEL TO</h3>
          <h1 className="text-preset-1 text-[80px]">SPACE</h1>
          <p className="text-preset-9 text-tertiary text-center text-[15px]">Let’s face it; if you want to go to space, you might as well genuinely go to outer space and not hover kind of on the edge of it. Well sit back, and relax because we’ll give you a truly out of this world experience!</p>
      </div>
...
{/* <>
      <div className="flex flex-col items-center p-6 pt-0 gap-6 md:p-32 md:pb-0 lg:p-0 lg:w-135 lg:items-start">
